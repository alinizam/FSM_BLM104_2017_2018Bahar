...
@NamedQueries({
    ...
    @NamedQuery(name = "DiscountCode.findUpperRate", query = "SELECT d FROM DiscountCode d WHERE d.rate > :rate")})
public class DiscountCode implements Serializable {
    ...
    public String toString() {
        return "Ders11.Ornek1.DiscountCode[ discountCode=" + discountCode + " ]";
    }
