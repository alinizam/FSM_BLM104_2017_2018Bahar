...
public class Ornek4 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        char islem = evt.getActionCommand().charAt(0);
        if(Character.isDigit(islem)){
            txtSonuc.setText(txtSonuc.getText()+islem);
        }else{
            
            if(islem == '+'){
                oncekiSayi = Integer.parseInt(txtSonuc.getText());
                txtSonuc.setText(null);
                enSonIslem = evt.getActionCommand().charAt(0);
            }else if(islem == '-'){
                oncekiSayi = Integer.parseInt(txtSonuc.getText());
                txtSonuc.setText(null);
                enSonIslem = evt.getActionCommand().charAt(0);
                ...
                if(enSonIslem == '+'){
                    int sonuc = oncekiSayi + Integer.parseInt(txtSonuc.getText());
